...
char findFirstIllegalChar(const std::string& line) {
    auto itr = line.begin();
    vector<char> stack{};
    unordered_map<char, std::function<bool(char)>> ops{
        {'(',[&](char c){stack.push_back(c);return false;}},
        {'{',[&](char c){stack.push_back(c);return false;}},
        {'[',[&](char c){stack.push_back(c);return false;}},
        {'<',[&](char c){stack.push_back(c);return false;}},
        {')',[&](char c){if(stack.back()=='('){stack.pop_back();return false;}return true;}},
        {'}',[&](char c){if(stack.back()=='{'){stack.pop_back();return false;}return true;}},
        {']',[&](char c){if(stack.back()=='['){stack.pop_back();return false;}return true;}},
        {'>',[&](char c){if(stack.back()=='<'){stack.pop_back();return false;}return true;}}
            };
...
int64_t calcSyntaxScore(const std::vector<std::string>& lines) {
    unordered_map<char, int64_t> values {
        {'0',0},
        {')',3},
        {']',57},
        {'}',1197},
